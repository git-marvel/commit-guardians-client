  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="h-52 w-40">
        {badgeTagUrl && <Badge url={badgeTagUrl} />}
      </div>
      <button
      ...
      >
        ...
        <img
          ...
          className="invert"
        />
        <div className="absolute -bottom-1 left-6 z-10 hidden w-64 translate-y-full rounded-full border border-blue-400 bg-sky-50 px-2 py-2 text-slate-800 shadow-sm transition duration-300 ease-in-out group-hover:flex">
